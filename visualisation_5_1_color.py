...
cwt_plot = win.addPlot(row=1, col=1, title = key + " N = " + str(N))
zoom_plot = win.addPlot(row=2, col=1, title = "Zoom")
main_plot = win.addPlot(row=3, col=1, title = "Scroll")
...
cmap = pg.ColorMap([0.0, 3.0, 12.0, 30.0],[(0,0,102), (0,204,0), (255,255,0), (255,0,0)])
img.setLookupTable(cmap.getLookupTable(start = 0.0, stop = 30.0))
hist = pg.HistogramLUTItem()
hist.setHistogramRange(0.0, 15.0, padding=0.1)
hist.setLevels(min=0.0, max=15.0)
hist.gradient.loadPreset('viridis')
hist.setImageItem(img)

hist.autoHistogramRange = False
win.addItem(hist, col = 2, row=1, rowspan = 3)
